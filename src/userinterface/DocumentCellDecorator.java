...
public abstract class DocumentCellDecorator extends DocumentCell {
     ...
     *
     * @param newLength: The new length of this scrollbar
     */
...
//        innerBarLength = (int) Math.round(length/getRatio());
    ...
    /**
     * Get the fraction of this scrollBar. How far is the scrollBar scrolled?
     *
     * @return The fraction of this scrollBar.
     */
    ...
    /**
     * Get the ratio of the scrollBar-length to the content-length.
     *
     * @return The ratio of this scrollBar.
     */
    ...
    /**
     * Set the fraction of this scrollBar.
     * If the fraction is greater than 1 it is set to 1.
     * If the fraction is negative, it is set to 0.
     * Otherwise it is set to the given fraction.
     *
     * @param fraction The desired new fraction for this scrollBar.
     */
    ...
    /**
     * Recalculates the innerBar length given a new ratio.
     * @param newRatio
     */
