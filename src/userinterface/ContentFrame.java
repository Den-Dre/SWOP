...
//	    rows.add(row5);
    ...
    /**
     * Initialize a {@code ContentFrame} with a given {@code ContentFrame}. Used for 
     * achieving a deep-copy of an existing {@code ContentFrame}.
     * 
     * @param frame : the {@code ContentFrame} that needs to be copied.
     */
     ...
     *
     * @return copy: a deep copied version of this {@code ContentFrame}
