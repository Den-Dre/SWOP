...
/**
 * A class extended from {@link AbstractFrame} to represent individual UI elements that need to be rendered. 
 * Classes like {@link UIButton}, {@link UIHyperlink} and {@link UITable} are derived from this class.
 */
public class DocumentCell extends AbstractFrame {

	/**
     * Initialize this {@code DocumentCell} with the given parameters.
     *
     * @param x: The x coordinate of this {@code DocumentCell}
     * @param y: The y coordinate of this {@code DocumentCell}
     * @param width: The width of this {@code DocumentCell}
     * @param height: The height of this {@code DocumentCell}
	...
	/**
     * Initialize this {@code DocumentCell} with the given {@code DocumentCell}. Used to achieve a
     * deep copy of a given {@code DocumentCell}
     * 
     * @param documentCell : the {@code DocumentCell} that will be copied.
     */
    ...
    /**
     * Create a deep copy of this {@code DocumentCell} object.
     *
     * @return copy: a deep copied version of this {@code DocumentCell}
    ...
    /**
     * render the graphics {@code g} of this {@code DocumentCell}.
     *
    ...
    /**
     * Handle a mouse click on this {@code DocumentCell}.
     *
    ...
    /**
     * Handle a resize of this {@code DocumentCell}.
     *
     * @param newWindowWidth: The width the {@code DocumentCell} will be resized to.
     * @param newWindowHeight: The height the {@code DocumentCell} will be resized to.
     */
    @Override
    ...
    /**
     * Method to determine if the click was in this {@code DocumentCell}s area.
     * 
     * @param x: the x-position of the click
     * @param y: the y-position of the click
     * @return True iff the given point lies in this {@code DocumentCell}s area including the edges
     */
...
//    	System.out.println("width: "+this.getWidth()+", height: "+this.getHeight());
    ...
    /**
     * The output generated by a mouse click on this {@code DocumentCell}.
    ...
    /**
     * Retrieve the name and value of this {@code DocumentCell}.
     *
     * <p>
     * Only applies if the {@code DocumentCell} has a name and value (e.g UITextInputField)
     * or can contain elements that do (e.g. UITable).
     * </p>
     *
     * @return An ArrayList with the name and value of the {@code DocumentCell} separated by a '=' sign.
     */
    ...
    /**
     * Return the maximum height of this {@code DocumentCell}.
     *
    ...
    /**
     * Return the maximum width of this {@code DocumentCell}.
     *
     * @return 1: this is always equal to 1.
     */
     ...
     * 
     * @return the height-to-width-ratio to use for strings in this {@code DocumentCell}
     */
    ...
    /**
     * The height to width ratio of this {@code DocumentCell},
