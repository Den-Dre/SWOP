...
public abstract class Pane extends AbstractFrame implements DocumentListener {
    ...
    /**
     * Abstract method returning a deep copy of this {@code Pane}
     */
    public abstract Pane deepCopy();

    /**
     * Set the {@link Pane} object that currently has focus.
     *
...
//    }
    ...
    /**
     * A variable of type {@link Array} containing the last known resize of this {@code Pane}
     */
